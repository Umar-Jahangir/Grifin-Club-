$(document).ready(function() {
    // Animations on scroll using jQuery
    ...
    // Modal functionality for both container and container-box images
    const setupModalForImages = (selector) => {
        if ($(selector).length) {
            const $modal = $(`
    ...
    // Setup modals for both types of containers
    setupModalForImages('.container');
    setupModalForImages('.container-box');
